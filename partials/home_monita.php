<?php
    if (!isset($communications[0]['visto'])) {
        if (count($communications) > 0 && isset($communications[0]['model']) && !empty($communications[0]['model']) && !empty($communications[0]['text'])) {
            ...
            $content = str_replace('[mes]', $meses_comu[$communications[0]['data']], $content);
            $content = str_replace('[codigo_produto]', $meses_comu[$communications[0]['data']], $content);
            $cdata = isset($communications[0]['data']) ? $communications[0]['data'] : 0;

            echo '
                <div class="comunicados-home">
                    <div class="comu-home-head">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                            ...
                            <text transform="matrix(1 0 0 1 705.5675 832.9199)" class="st4"><tspan x="0" y="0" class="st5 st2 st6">LEVANDO PESSOAS COMUNS,</tspan><tspan x="0" y="48.6" class="st5 st2 st6">A RESULTADOS EXCEPCIONAIS.</tspan></text>
                        </svg>
                        <span class="close" onclick="fechar_notif()">&#10005;</span>
                    </div>
                    <div class="comunicados">
                        <p class="data_comunicado">' . $cdata . '</p>'
                        . $content .
                    '</div>
                </div>
                <div class="filtro_preto"></div>
            ';

            /*
            $query = "UPDATE communications SET visto = 1 WHERE data = '$cdata' AND cpf = $cpf";
...
<section class="wrapper home_box">
    <div class="linha_quadro">
        <div class="quadro-home">
    ...
    <div class="linha_quadro">
        <div class="quadro-home">
            <a class="home-box" href="<?php echo '//' . $config['baseUrl'] ?>/treinamento">
                <div class="filtro"></div>
                <p><span class="home-box-title">Treinamento</span></p>
            </a>
        </div>
        <div class="quadro-home">
